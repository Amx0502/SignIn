...
.task-editor-form{max-height:min(68vh,680px);overflow-y:auto;padding:2px 4px 4px}.editor-layout{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.editor-section{min-width:0;padding:16px 16px 6px;border:1px solid #dbeafe;border-radius:18px;background:linear-gradient(145deg,#fff 0%,#f8fbff 100%);box-shadow:0 10px 28px rgb(37 99 235 / 6%)}.editor-section header{display:flex;align-items:center;gap:10px;margin-bottom:15px;padding-bottom:12px;border-bottom:1px solid #e8eef8}.editor-section header strong,.editor-section header small{display:block}.editor-section header strong{color:#172033;font-size:15px}.editor-section header small{margin-top:2px;color:#8492a6;font-size:11px}.section-index{display:grid;place-items:center;width:34px;height:34px;border-radius:11px;background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;font-size:11px;font-weight:800;box-shadow:0 7px 16px rgb(37 99 235 / 22%)}.el-select,.el-input-number{width:100%}.coordinate-row,.schedule-row{display:flex;align-items:center;gap:8px;width:100%}.coordinate-row .el-input,.schedule-row .el-date-editor{flex:1;min-width:0}.field-tip{display:block;margin-top:7px;color:#64748b;font-size:11px}.schedule-list,.date-range{display:grid;gap:8px;width:100%}.date-range{grid-template-columns:1fr 1fr}.date-range .el-date-editor{width:100%}.switch-options{display:grid;gap:8px;padding:12px;border-radius:12px;background:#eff6ff}.switch-options .el-checkbox{margin-right:0}
